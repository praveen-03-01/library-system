...
<body>
        ...
        <div class="container">
            <div class="navbar">
                <div class="logo">
                   ...
                   <span href="index.php"><h3 style="color:white;">Online Library Management System</h3></span>
                </div>
    ...
    <?php
        ...
        <div class="container">
            <div class="navbar">
                <div class="logo">
                   <span href="index.php"><img src="images/logo2.jpg" alt="Logo" style="border-radius: 50%;"></span> 
                   <span href="index.php"><h3 style="color:white;">Online Library Management System</h3></span>
                </div>
                <div class="title">
